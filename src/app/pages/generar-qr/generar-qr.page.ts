...
export class GenerarQrPage implements OnInit {
  ...
  redirectToQrConfirmation(idAsignatura : string, idSeccion : string, nombreAsignatura: string, siglaAsignatura : string, nombreSeccion : string){
      let detalleAsig: DetalleAsignatura = {
      ...
      this.utilsSvc.saveInLocalStorage('detalleAsistencia', detalleAsig);
      this.router.navigate(['/confirmacion-qr'])
  }
